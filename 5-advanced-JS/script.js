...
//function constructor always starts with capital letter
/*
var Person = function(name,yearOfBrith, job) {
    this.name = name;
    this.yerOfBrith = yearOfBrith;
    this.job = job;
}

Person.prototype.calculateAge = this.calculateAge = function() {
        console.log(2016 - this.yerOfBrith);
    }
...
designerQuestion('Jarek');
designerQuestion('Kasia');

interviewQuestion('teacher')('Adrian');
...
var john = {
    ...
    presentation: function(style, timeOfDay) {
        if (style === 'formal') {
            ...
            console.log('Hay! What\'s up? I\'m ' + this.name + ', I\'m a ' + this.job + ' and I\'m ' + this.age + ' years old. Have a nice ' + timeOfDay + '.');
        } else {
            console.log();
        }
    }
